...
<aside class="filter-panel" aria-label="Filtros de partículas">
  ...
  {#if mode !== 'search'}<fieldset><legend>Familia</legend><div class="choice-grid">
    {#each [['all','Todas'],['composite','Compuestas'],['force','Interacciones'],['quark','Quarks'],['lepton','Leptones'],['gauge','Bosones gauge'],['scalar','Higgs'],['theory','Hipotéticas'],['string','Cuerdas y branas'],['technology','Tecnología'],['biology','Biología · escala']] as option}
