...
const topicRows: Array<[string, string, string]> = [
  ...
  ['Hadrones', 'Tetraquarks y pentaquarks', 'Son familias de hadrones exóticos observados con contenido mínimo de cuatro o cinco quarks; su organización interna concreta puede seguir en debate.'],
  ['Hadrones', 'Confinamiento', 'Los quarks y gluones con color no aparecen aislados en condiciones ordinarias; se hadronizan.'],
  ['Átomos y núcleos', 'Átomo general', 'La ficha didáctica reúne protones, neutrones y electrones; cada especie real se distingue por Z, N y su estado electrónico.'],
  ...
  ['Más allá', 'Candidatos de colisionador', 'Leptoquarks, leptones neutros pesados, bosones Z′/W′ y quarks vectoriales son familias buscadas activamente, todavía sin detección confirmada.'],
  ['Más allá', 'Dimensiones extra', 'Excitaciones de Kaluza–Klein, radiones y microagujeros negros aparecen en modelos concretos; las búsquedas establecen límites dependientes del escenario.'],
...
const manualDetails: Record<string, string> = {
  ...
  'Átomo general': 'No representa un isótopo particular. Z fija el número de protones y, en un átomo neutro, el de electrones; N cuenta neutrones. La nube electrónica es un estado cuántico y no una colección de órbitas planetarias.',
  'Tetraquarks y pentaquarks': 'Los experimentos han observado numerosos estados exóticos. La etiqueta describe contenido mínimo; distinguir configuraciones compactas y moléculas hadrónicas exige medidas adicionales.',
  ...
  'Tecnología como comparador': 'El atlas la mantiene en una capa independiente para no mezclar ingeniería con partículas. Una publicación puede informar una longitud de puerta, canal o transferencia subnanométrica mientras el dispositivo completo ocupa mucho más.',
  ...
  'Candidatos de colisionador': 'Cada familia produce firmas distintas y sus límites dependen de masas, acoplamientos, vidas y canales de desintegración supuestos. Una exclusión concreta no descarta toda la familia de modelos.',
  'Dimensiones extra': 'La compactificación puede generar torres de Kaluza–Klein o un radion. Los microagujeros negros sólo serían accesibles si la escala gravitatoria efectiva fuese mucho menor que la de Planck habitual.',
